...
#PBS -N trimming
#PBS -A PMIU0157
#PBS -e /fs/project/PMIU0157/Gwonjin_Lee/Soybean_project/scripts/outtext/trimming.err
#PBS -o /fs/project/PMIU0157/Gwonjin_Lee/Soybean_project/scripts/outtext/trimming.out
#PBS -q serial
#PBS -l nodes=1:ppn=8
